...
public class ProcessBuilderVisitorAdapter extends AdviceAdapter {
    ...
    protected void onMethodEnter() {
        mv.visitTypeInsn(NEW, "xxx/javaopenrasp/filters/rce/PrcessBuilderFilter");
        mv.visitInsn(DUP);
        mv.visitMethodInsn(INVOKESPECIAL, "xxx/javaopenrasp/filters/rce/PrcessBuilderFilter", "<init>", "()V", false);
        mv.visitVarInsn(ASTORE, 1);
        mv.visitVarInsn(ALOAD, 1);
        mv.visitVarInsn(ALOAD, 0);
        mv.visitFieldInsn(GETFIELD, "java/lang/ProcessBuilder", "command", "Ljava/util/List;");
        mv.visitMethodInsn(INVOKEVIRTUAL, "xxx/javaopenrasp/filters/rce/PrcessBuilderFilter", "filter", "(Ljava/lang/Object;)Z", false);
